                    ...
                    <div className="parallax-content">
                        <div className="hero-copy">
                            ...
                            <div className="hero-buttons">
                                ...
                                <Link to="/gallery" className="btn btn-outline-light btn-large">
                ...
                <div className="container">
                    <div className="cta-content">
                        ...
                        <div className="cta-buttons">
                            <button className="btn btn-primary btn-large" onClick={() => openBooking()}>Book Now</button>
                            ...
                            <div className="info-card">
                                ...
                                <div className="social-links-container">
                                    ...
                                    <div className="social-links">
                                        <a href="https://www.facebook.com/itsouRstudioo/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Facebook" title="Facebook">
                                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
                                        </a>
                                        <a href="https://www.instagram.com/its_our_studio/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Instagram" title="Instagram">
                                        ...
                                        <a href="https://www.tiktok.com/@itsourstudio" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="TikTok" title="TikTok">
                                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5"></path></svg>
                                        </a>
                                    </div>
                                </div>
                            </div>
