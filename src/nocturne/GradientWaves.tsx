...
const GradientWaves = ({
    ...
    useEffect(() => {
        ...
        try {
            ...
            // Context creation can still fail behind a passing capability
            // probe (driver blocklists, too many live contexts). The CSS
            // fallback underneath stays visible.
            return;
        }
        ...
        // The loop is parked whenever the hero scrolls out of view or the tab
        // is backgrounded — a raymarcher is far too expensive to leave running.
        let raf = 0;
        let isVisible = true;
        ...
        // Built once; live prop changes are pushed through the effect below.
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, []);

    // Push prop updates onto the live uniforms without rebuilding the context.
    useEffect(() => {
